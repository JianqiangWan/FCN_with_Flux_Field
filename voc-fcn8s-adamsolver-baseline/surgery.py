...
def transplant(new_net, net, suffix=''):
    ...
    """
    params1 = ['conv1_1', 'conv1_2', 'conv2_1', 'conv2_2', \
    ...
    # fc6 fc7 fc6_flux fc7_flux
    for i in range(2):
        new_net.params['fc6'][i].data.flat = net.params['fc6'][i].data.flat
        # new_net.params['fc6_flux'][i].data.flat = net.params['fc6'][i].data.flat
        new_net.params['fc7'][i].data.flat = net.params['fc7'][i].data.flat
        # new_net.params['fc7_flux'][i].data.flat = net.params['fc7'][i].data.flat
